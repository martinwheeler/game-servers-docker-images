...
ARG VALHEIM_BUILD_ID=25253791
ARG VALHEIM_LINUX_DEPOT_MANIFEST_ID=9055200629726788899
ARG VALHEIM_SHARED_LINUX_DEPOT_MANIFEST_ID=4559160656493359681

ENV VALHEIM_BUILD_ID="${VALHEIM_BUILD_ID}" \
  VALHEIM_LINUX_DEPOT_MANIFEST_ID="${VALHEIM_LINUX_DEPOT_MANIFEST_ID}" \
  VALHEIM_SHARED_LINUX_DEPOT_MANIFEST_ID="${VALHEIM_SHARED_LINUX_DEPOT_MANIFEST_ID}" \
  SERVER_PORT=2456 \
  SERVER_PUBLIC=1 \
...
ARG VALHEIM_PLUS_VERSION=0.10.1.2

ENV VALHEIM_PLUS_VERSION="${VALHEIM_PLUS_VERSION}"
